...
INSIGHT_TOPICS = [
    ...
    {"title": "현금흐름이 거짓말을 안 한다",  "subtitle": "순이익보다 현금흐름을 봐야 하는 이유",                   "emoji": "💸", "tag": "재무"},
    {"title": "재무제표 5분 훑기",            "subtitle": "이것만 보면 나쁜 기업 걸러낼 수 있다",                   "emoji": "📑", "tag": "재무"},
    {"title": "분식회계 의심 신호",           "subtitle": "숫자가 거짓말할 때 나타나는 패턴",                       "emoji": "🔍", "tag": "재무"},
    {"title": "ROE 20%의 비밀",              "subtitle": "자기자본이익률 높은 기업은 왜 강한가",                    "emoji": "💎", "tag": "재무"},
    {"title": "부채비율이 높아도 괜찮은 경우","subtitle": "무조건 나쁜 게 아닌 부채의 두 얼굴",                     "emoji": "⚖️", "tag": "재무"},
    {"title": "캔들 하나로 시장 심리 읽기",   "subtitle": "도지·망치·장악형 — 캔들이 말하는 것",                    "emoji": "🕯️", "tag": "차트"},
    {"title": "적삼병 vs 흑삼병",            "subtitle": "3개 캔들이 만드는 강력한 추세 신호",                      "emoji": "📊", "tag": "차트"},
    {"title": "윗꼬리와 아랫꼬리의 진실",     "subtitle": "거절당한 가격 — 매수·매도 세력의 흔적",                   "emoji": "📉", "tag": "차트"},
]
